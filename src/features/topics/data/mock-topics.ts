...
const topicSamples = [
  {
    ...
    outline: '<p>Khai thác vẻ đẹp văn hóa chợ nổi, phỏng vấn tiểu thương và du khách. Đề xuất các giải pháp bảo tồn văn hóa sông nước kết hợp phát triển du lịch bền vững.</p><ul><li>Bối cảnh: Chợ nổi sáng sớm</li><li>Nhân vật: Cô Tư bán bún riêu, Anh Ba lái tàu</li><li>Vấn đề: Ô nhiễm môi trường, sự cạnh tranh của đường bộ</li></ul>',
    type: 'broadcast',
  },
  {
    title: 'Tin tức: Lễ khánh thành cầu Cần Thơ 2 - Kết nối giao thương',
    outline: '<p>Ghi nhận không khí buổi lễ, phát biểu của lãnh đạo thành phố và Bộ GTVT. Phỏng vấn người dân về kỳ vọng đổi thay kinh tế.</p>',
    type: 'broadcast',
  },
  {
    title: 'Ký sự: Người giữ hồn đờn ca tài tử Nam Bộ',
    outline: '<p>Chân dung nghệ nhân ưu tú Nguyễn Văn A. Hành trình 50 năm gắn bó với nghệ thuật truyền thống. Những trăn trở về việc truyền nghề cho thế hệ trẻ.</p>',
    type: 'combo',
  },
  {
    title: 'Điều tra: Tình trạng sạt lở bờ sông Hậu - Báo động đỏ',
    outline: '<p>Ghi nhận tại các điểm nóng sạt lở. Phỏng vấn các hộ dân bị ảnh hưởng. Ý kiến chuyên gia về nguyên nhân và giải pháp công trình/phi công trình.</p>',
    type: 'broadcast',
  },
  {
    title: 'Talkshow: Khởi nghiệp nông nghiệp công nghệ cao',
    outline: '<p>Khách mời: CEO Farm Xanh. Chia sẻ kinh nghiệm ứng dụng IoT vào trồng dưa lưới. Cơ hội và thách thức cho thanh niên nông thôn.</p>',
    type: 'digital',
  },
  {
    title: 'Tin nhanh: Cập nhật tình hình triều cường rằm tháng 9',
    outline: '<p>Thông tin các tuyến đường ngập sâu nội ô. Cảnh báo đỉnh triều và khung giờ ngập. Hướng dẫn người dân tham gia giao thông an toàn.</p>',
    type: 'social',
  },
  {
    title: 'Phóng sự ảnh: Mùa hoa hoàng yến rực vàng phố thị',
    outline: '<p>Bộ ảnh ghi lại vẻ đẹp đường phố Cần Thơ mùa hoa nở. Góc nhìn nghệ thuật về kiến trúc đô thị hòa quyện thiên nhiên.</p>',
    type: 'print',
  },
  {
    title: 'Thực tế: Một ngày làm công nhân vệ sinh môi trường',
    outline: '<p>Trải nghiệm thực tế công việc vất vả của công nhân vệ sinh đêm khuya. Thông điệp về ý thức bảo vệ môi trường đô thị.</p>',
    type: 'broadcast',
  },
  {
    title: 'Văn hóa: Ẩm thực đường phố - Nét duyên thầm đất Tây Đô',
    outline: '<p>Khám phá các món ăn vặt trứ danh: chuối nếp nướng, bánh cống, nem nướng. Câu chuyện văn hóa đằng sau mỗi món ăn.</p>',
    type: 'social',
  },
  {
    title: 'Giáo dục: Chuyển đổi số trong trường học vùng ven',
    outline: '<p>Mô hình lớp học thông minh tại huyện Phong Điền. Hiệu quả từ việc ứng dụng bảng tương tác và học liệu số.</p>',
    type: 'digital',
  },
  {
    title: 'Nông nghiệp: Mô hình nuôi lươn không bùn hiệu quả cao',
    outline: '<p>Giới thiệu kỹ thuật nuôi mới. Hiệu quả kinh tế so với nuôi truyền thống. Đầu ra sản phẩm và tiềm năng xuất khẩu.</p>',
    type: 'broadcast',
  },
  {
    title: 'Y tế: Bệnh viện Đột quỵ Cần Thơ - Điểm sáng y tế vùng ĐBSCL',
    outline: '<p>Ứng dụng công nghệ AI trong chẩn đoán sớm đột quỵ. Các ca cứu sống ngoạn mục trong giờ vàng.</p>',
    type: 'broadcast',
  },
  {
    title: 'Thể thao: Cần Thơ sẵn sàng cho Đại hội TDTT Đồng bằng',
    outline: '<p>Công tác chuẩn bị cơ sở vật chất. Kỳ vọng vào các bộ môn thế mạnh: Vovinam, Bơi lội, Điền kinh.</p>',
    type: 'broadcast',
  },
  {
    title: 'Cuộc sống: Xe buýt đường sông - Trải nghiệm mới cho du khách',
    outline: '<p>Trải nghiệm tuyến buýt đường sông Ninh Kiều - Bình Thủy. Đánh giá chất lượng dịch vụ và tiềm năng thu hút khách.</p>',
    type: 'combo',
  },
  {
    title: 'Kinh tế: Xuất khẩu gạo 2025 - Cơ hội từ thị trường EU',
    outline: '<p>Phân tích tác động của EVFTA. Các doanh nghiệp gạo Cần Thơ chuẩn bị gì để đáp ứng tiêu chuẩn khắt khe?</p>',
    type: 'print',
  },
]
...
export const mockTopics: Topic[] = Array.from({ length: 20 }, (_, index) => {
  ...
  if (['pending_b2', 'pending_b3', 'approved', 'rejected'].includes(status)) {
    approvalHistory.push({
      id: `ah-${index}-2`,
      userId: editor.id,
  ...
  return {
    ...
    deadline: new Date(createdAt.getTime() + (Math.random() * 30 + 7) * 86400000),
...
export const getPendingTopicsForApproval = (level: 'B1' | 'B2' | 'B3'): Topic[] => {
  const statusMap = {
    B1: 'pending_b1',
    B2: 'pending_b2',
    B3: 'pending_b3',
